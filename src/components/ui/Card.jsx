...
export const CardTitle = ({ className, children }) => <h3 className={`text-lg font-semibold leading-none tracking-tight text-[var(--color-text-primary)] ${className}`}>{children}</h3>;