const ConfirmationModal = ({ title, message, onConfirm, onClose }) => (
    <div className="fixed inset-0 bg-black bg-opacity-60 h-full w-full z-50 flex justify-center items-center">
        <div className="p-8 w-11/12 md:w-1/3 shadow-lg rounded-xl bg-white text-center transform transition-all animate-fade-in">
            ...
            <div className="flex justify-center space-x-4">
                ...
                <button onClick={onConfirm} className="px-6 py-2 rounded-lg bg-red-600 text-white font-semibold shadow-md hover:bg-red-700 transition duration-300">Confirm</button>
            </div>
        </div>
    </div>
);
