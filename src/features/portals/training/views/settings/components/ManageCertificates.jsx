...
// New UI enhancement: Icon helper components
...
const ManageCertificates = ({ items, onAdd, onDelete, onUpdate, placeholder }) => {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <Card className="lg:col-span-2 p-6 rounded-2xl animate-fade-in">
                    <CardContent className="p-0">
                        <SearchInputField placeholder="Search certificates..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
                ...
                <Card className="p-6 rounded-2xl animate-fade-in h-fit">
                    <CardContent className="p-0">
                        <h3 className="text-lg font-semibold text-[var(--color-text-primary)] mb-4">Add New Certificate</h3>
